...
The workshop will start at 9 AM and end at 5 PM, with multiple coffee breaks and a lunch break. All materials for the course will be viewable online at <<LINK TBD>> and hosted on GitHub at [github.com/posit-conf-2023/shiny-r-prod](https://github.com/posit-conf-2023/shiny-r-prod). We also have a [discussion board](https://github.com/rstudio-conf-2022/shiny-prod-apps/discussions) within the GitHub repository available for collaboration on questions and issues. For real-time messaging, we will be using a specific channel within the Posit Conf 2023 Discord. Additional details for onboarding will be sent prior to the workshop.
